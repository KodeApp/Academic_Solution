...
public class StudentAdapter extends RecyclerView.Adapter<StudentAdapter.StudentViewHolder> {
    ...
    public void setOnItemClickListerner(StudentAdapter.onItemClickListerner onItemClickListerner) {
    ...
    public  static class StudentViewHolder extends RecyclerView.ViewHolder implements View.OnCreateContextMenuListener{
        ...
        public StudentViewHolder(@NonNull View itemView,onItemClickListerner onItemClickListerner) {
            super(itemView);
    ...
    public StudentViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new StudentViewHolder(itemView,onItemClickListerner);
    }
