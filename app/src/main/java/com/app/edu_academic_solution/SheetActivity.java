...
public class SheetActivity extends AppCompatActivity {
    ...
    private void showTable() {
        ...
        if (idArray == null || rollArray == null || nameArray == null) {
            // Handle the case when the arrays are null
        ...
        for (int i=0; i < rowSize; i++){
            ...
            if (i > 0 && i <= rollArray.length && i <= nameArray.length) {
...
//            name_tvs[i].setText(nameArray[i-1]);
        ...
        for (int i = 0; i< rowSize; i++){
            ...
            int evenColor = Color.parseColor("#EEEEEE");
            int oddColor = Color.parseColor("#E4E4E4");

            Drawable evenDrawable = new ColorDrawable(evenColor);
            Drawable oddDrawable = new ColorDrawable(oddColor);

            if (i % 2 == 0) {
                rows[i].setBackground(evenDrawable);
            } else {
                rows[i].setBackground(oddDrawable);
            }
